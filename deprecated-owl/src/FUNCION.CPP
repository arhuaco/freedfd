...
/*
	...
	auxiliares.
																									*/
#ifndef __FUNCION_CPP
#define __FUNCION_CPP



 static bool FueraDeRango(Token *UnToken){
 ...
 static bool NoEsReal( Token *UnToken ){
 ...
 static bool NoEsLogico( Token *UnToken ){
 ...
 static bool NoEsString( Token *UnToken ){
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 template <class TIPO> static Token * ConsigueToken( TIPO Valor ){
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 void Random( Token **Pila ){
	...
	long double ValorRetorno =
							  ceill( fmod(  ValorAleatorio, ValorDominio ) );
	Token *TokenRetorno= ConsigueToken( ValorRetorno );
	if( Buzon.GetHuboError() )
	  return ;
	delete Desapila( Pila );
...
inline void MenorIgual( Token **Pila ){
  Relacion( Pila, 3 );
  return ;
}
...
inline void MayorIgual( Token **Pila ){
  Relacion( Pila, 4 );
  return ;
}
...
inline void NoIgual( Token **Pila ){
  Relacion( Pila, 6 );
  return ;
}
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 inline void Multiplicar( Token **Pila ){
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 inline void Dividir( Token **Pila ){
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  void Substring( Token **Pila , int NArgumentos){
	 ...
	 for( register int Cont=Inicio-1 ; (Cont<Inicio+Hasta-1)&&(Cont<Largo) ;
			++Cont )
