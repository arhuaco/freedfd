...
#define __INCLUDES_CPP
  ...
  enum TipoError{  LOS_TIPOS_NO_COINCIDEN, ID_NO_ES_ARREGLO,
						DIMENSION_NO_VALIDA,	CONSTANTE_NUMERICA_ILEGAL,
						NOMBRE_VARIABLE_INCORRECTO, FUNCION_REQUIERE_PARAMETRO,
