    ...
    We need help to finish the new version. We want it to work in Linux
    and Friends and Windows. Please do visit our webpage:

    http://freedfd.freaks-unidos.net
    
    You can also write to arhuaco@freaks-unidos.net, if you wish to find
    out more about the project.

    The file  "bwcc32.dll" belongs to Borland.
