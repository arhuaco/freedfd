...
enum TipoError {
  ...
  DIVISION_POR_CERO,
  /*SUBINDICE_NO_VALIDO, */ INDICES,
  ILEGAL_COMA_O_CADENA_VACIA,
  SOLO_VARIABLES,
  NO_INDICES,
  TIPO_DEBE_SER_LOGICO,
  VINICIAL_CONTADOR,
  VFINAL_CONTADOR,
  INCREMENTO_CONSTANTE,
  CONTADOR_REAL,
  LIMITE_REAL,
  PARAMETRO_ILEGAL,
  PARAMETRO_REPETIDO,
  ILEGAL_NOMBRE_SUBPROGRAMA,
  SUBPROGRAMA_NO_EXISTE,
  SUBPROGRAMA_REPETIDO,
  MUCHOS_ARGUMENTOS,
  POCOS_ARGUMENTOS,
