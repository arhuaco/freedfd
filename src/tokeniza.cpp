...
inline int
EsDigito (char Caracter)
{
  return (Caracter >= '0') && (Caracter <= '9');
}

inline int
EsEspacio (char Caracter)
{
  return Caracter == ' ';
}
...
void
PreprocesarExpresion (Token * Expresion)
{
...
void
InsertarDeUltimo (Token * Nuevo, Token ** Inicio, Token ** Ultimo)
{
  if (!(*Ultimo))
    *Inicio = Nuevo;
  else
